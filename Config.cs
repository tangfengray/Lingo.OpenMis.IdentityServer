...
namespace Lingo.OpenMis.IdentityServer
{
    public class Config
    {
        /// <summary>
        ...
        public static IEnumerable<ApiScope> GetApiResources()
        {
            return new[]
            {
                new ApiScope("api1", "Lingbug Api1"),
                new ApiScope("api2", "Lingbug Api2")
            };
        ...
        {
            return string.IsNullOrWhiteSpace(valueString) ? String.Empty : valueString.Sha256();
        }
    }
}
